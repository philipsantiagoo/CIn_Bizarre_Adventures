...
def play():
    ...
    janela_temp = pygame.display.set_mode((1, 1))
    ...
    pygame.display.set_caption('CIn Bizarre Adventures')
        ...
        for camada in mapa.visible_layers:
            if hasattr(camada, 'tiles'):
                for x, y, tile in camada.tiles():
                    janela.blit(tile, (x * mapa.tilewidth, y * mapa.tileheight))
        
        pygame.display.flip() # atualiza a janela de acordo com os novos conteúdos
